...
function TourInfoContainer({ tourData }) {
  ...
  return (
    <div className="tour-page-background text-white py-10"> {/* Remove fixed height to allow growth */}
      <div className="container mx-auto flex flex-col justify-between"> {/* Flexbox to distribute space */}
        ...
        <div className="tour-container row mt-5 flex-grow"> {/* Allow this row to grow and fill space */}
          {/* Description Column */}
          <div className="description-container p-10 col-md-8"> {/* Added right border and padding */}
            {/* Icons Row */}
            ...
            {combinedDescriptions.map((desc, index) => (
              <p key={index} className="description-text">{/* Added border below paragraph */}
                {desc}
              </p>
            ))}
          </div>
          ...
          <div className="contactUs-container col-md-4 flex justify-center items-center">
            <div className="w-full  max-w-sm  text-white p-8 text-center">
              ...
              <p>
                Email: <a href="mailto:info@lisbontours.com" className>info@lisbontours.com</a>
              </p>
